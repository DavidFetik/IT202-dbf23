...
<tr><td> <em>Student: </em> David Fetik (dbf23)</td></tr>
<tr><td> <em>Generated: </em> 10/21/2023 12:04:32 AM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-103-F23/it202-m1-gettingstarted/grade/dbf23" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://snipboard.io/9GShC0.jpg"/></td></tr>
<tr><td> <em>Caption:</em> <p>Installed Extensions<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://snipboard.io/IAZuVs.jpg"/></td></tr>
...
<tr><td> <em>Response:</em> <p>I learned what VSCode is and a few of the useful extensions it<br>has to make my coding more efficient. I also learned what Git and<br>GitHub are; how to make a copy of a file, make changes to<br>that copy, confirm those changes, and then push the files to Hub where<br>other people can work on my file. I was also introduced to PHP<br>and reintroduced to what SQL is. I&#39;ve only ever used jGRASP for Java<br>and IDLE for Python so I&#39;m kind of overwhelmed with how much I&#39;m<br>learning in such a short amount of time.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I was really struggling with Step 7 of the instructions above, but then<br>I just assumed that I didn&#39;t actually have to use the terminal since<br>I already added the file on Hub. I also was really struggling with<br>how to create an SQL Database and create the connection to VSCode, but<br>then I looked at the slides on Canvas and found the solution.&nbsp;<br></p><br></td></tr>
</table></td></tr>
